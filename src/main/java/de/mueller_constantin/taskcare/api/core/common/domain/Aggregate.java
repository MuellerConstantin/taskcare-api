...
public abstract class Aggregate {
     ...
     */
    protected abstract void processEvent(DomainEvent event) throws IllegalArgumentException;
     ...
     */
    protected final void applyChange(DomainEvent event) throws IllegalArgumentException {
